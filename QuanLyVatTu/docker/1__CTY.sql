...
GRANT EXECUTE ON SP_TaoTaiKhoan_CongTy TO CongTy_Role;

-- Cấm tuyệt đối nhóm Chi Nhánh và User (nếu họ lỡ login vào server này)
DENY EXECUTE ON SP_TaoTaiKhoan_CongTy TO ChiNhanh_Role;
DENY EXECUTE ON SP_TaoTaiKhoan_CongTy TO User_Role;
